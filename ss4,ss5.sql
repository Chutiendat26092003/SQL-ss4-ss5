...
( NAME = 'SalesDB_log', FILENAME = 'C:\Program Files\Microsoft SQL Server\MSSQL15.SQLEXPRESS\MSSQL\DATA\SalesDB_log.ldf',
 ...
 USE CUST_DB
 ALTER DATABASE CUST_DB
 ADD FILE ( NAME = 'Cust_DB1', FILENAME = 'C:\Program Files\Microsoft SQL Server\MSSQL15.SQLEXPRESS\MSSQL\DATA\Cust_DB1.mdf')
 TO FILEGROUP FG_ReadOnly ALTER DATABASE CUST_DB
 MODIFY FILEGROUP FG_ReadOnly DEFAULT

 --8 
 DROP DATABASE TestDB --  xóa database 
 
 --9 
 CREATE DATABASE AdventureWorks_dbss100 ON
 ( NAME = 'AdventureWorks2019', FILENAME = 'C:\Program Files\Microsoft SQL Server\MSSQL15.SQLEXPRESS\MSSQL\DATA\AdventureWorks_data_100.ss')
